...
#write a program that allow the user to solve question and display the time the user start and when it end 
#determine the number of passed question abd the  number of failed
# display result if you user pass or fail 